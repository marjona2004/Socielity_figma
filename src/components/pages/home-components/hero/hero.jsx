...
export const Hero = () => {
  return <div className="mb-[100px]">
       <h1 className="text-center text-black font-bold text-6xl  ">Your Private Online Marketplace <br /> Where <span className="text-blue-600 ">Socielities </span> That Comprise Your <br /> Personal <span className="text-blue-600  "> World</span></h1> 
